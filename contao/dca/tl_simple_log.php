...
$GLOBALS['TL_DCA']['tl_simple_log'] = [
    ...
    'list' => [
        ...
        'global_operations' => [
            'clear' => [
                ...
                'icon' => 'delete.svg',
                'class' => 'header_icon',
                'attributes' => 'onclick="if(!confirm(\'' . ($GLOBALS['TL_LANG']['tl_simple_log']['clearConfirm'] ?? '') . '\'))return false"',
            ],
        ],
        'operations' => [
            'show' => [
    ...
    'fields' => [
        ...
        'tstamp' => [
            'label' => &$GLOBALS['TL_LANG']['tl_simple_log']['tstamp'],
            'sorting' => true,
            'flag' => DataContainer::SORT_DAY_DESC,
        ...
        'status' => [
            'filter' => true,
            'sorting' => true,
            'reference' => &$GLOBALS['TL_LANG']['tl_simple_log']['status_options'],
        ...
        'source' => [
            'filter' => true,
            'reference' => &$GLOBALS['TL_LANG']['tl_simple_log']['source_options'],
            'sql' => "varchar(16) NOT NULL default ''",
        ],
        'last_attempt' => [
            'sql' => "int(10) unsigned NOT NULL default 0",
