...
$GLOBALS['TL_DCA']['tl_simple_notification'] = [
    'config' => [
        'dataContainer' => DC_Table::class,
        'ctable' => ['tl_simple_message'],
        'switchToEdit' => true,
    ...
    'fields' => [
        ...
        // code passes to SimpleNotifyCenter::send(), so it stays editable.
        'alias' => [
            'exclude' => true,
            'inputType' => 'text',
        ...
        'type' => [
            ...
            'reference' => &$GLOBALS['TL_LANG']['tl_simple_notification']['type_options'],
