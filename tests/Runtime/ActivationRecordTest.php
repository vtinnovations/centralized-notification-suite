...
class ActivationRecordTest extends TestCase
{
    ...
    public static function inapplicableRecords(): iterable
    {
        ...
        // Not "revoked": a withdrawal is a state this client must be able to read and apply,
        // and is covered in RevocationTest. What is refused is a status this build cannot
        // reason about, because guessing at it could only ever guess in favour of granting.
        yield 'an unrecognised status' => [['validation_status' => 'suspended'], 'unknown_status'];
        yield 'a missing status' => [['validation_status' => null], 'unknown_status'];
